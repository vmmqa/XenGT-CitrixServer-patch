...
public class ASDCConfiguration implements IConfiguration {
    ...
    public ASDCConfiguration(Properties configProperties, String certLocation) {
        ...
        if (configProperties.getProperty(PROP_ML_DISTRIBUTION_ARTIFACT_TYPES) != null) {
            String[] artTypeList = configProperties.getProperty(PROP_ML_DISTRIBUTION_ARTIFACT_TYPES).split(",");
        ...
        if (configProperties.getProperty(PROP_ML_DISTRIBUTION_MSG_BUS_ADDRESSES) != null) {
            String[] msgBusList = configProperties.getProperty(PROP_ML_DISTRIBUTION_MSG_BUS_ADDRESSES).split(",");
    ...
    public boolean activateServerTLSAuth() {
        String value = configProperties.getProperty(PROP_ML_DISTRIBUTION_ACTIVE_SERVER_TLS_AUTH);
        return value == null ? false : Boolean.parseBoolean(value);
    }

    @Override
    public String getAsdcAddress() {
        return configProperties.getProperty(PROP_ML_DISTRIBUTION_ASDC_ADDRESS);
    }

    @Override
    public String getConsumerGroup() {
        return configProperties.getProperty(PROP_ML_DISTRIBUTION_CONSUMER_GROUP);
    }

    @Override
    public String getConsumerID() {
        return configProperties.getProperty(PROP_ML_DISTRIBUTION_CONSUMER_ID);
    }

    @Override
    public String getEnvironmentName() {
        return configProperties.getProperty(PROP_ML_DISTRIBUTION_ENVIRONMENT_NAME);
    }

    @Override
    public String getKeyStorePassword() {
        return Password.deobfuscate(configProperties.getProperty(PROP_ML_DISTRIBUTION_KEYSTORE_PASSWORD));
    }

    @Override
    public String getKeyStorePath() {
        return certLocation + configProperties.getProperty(PROP_ML_DISTRIBUTION_KEYSTORE_FILE);
    }

    @Override
    public String getPassword() {
        return Password.deobfuscate(configProperties.getProperty(PROP_ML_DISTRIBUTION_PASSWORD));
    }

    @Override
    public int getPollingInterval() {
        return Integer.parseInt(configProperties.getProperty(PROP_ML_DISTRIBUTION_POLLING_INTERVAL));
    }

    @Override
    public int getPollingTimeout() {
        return Integer.parseInt(configProperties.getProperty(PROP_ML_DISTRIBUTION_POLLING_TIMEOUT));
    }
    ...
    public String getUser() {
        return configProperties.getProperty(PROP_ML_DISTRIBUTION_USER);
    }
    ...
    public Boolean isUseHttpsWithDmaap() {
        String useHTTPS = configProperties.getProperty(PROP_ML_DISTRIBUTION_HTTPS_WITH_DMAAP);
    ...
    public boolean getASDCConnectionDisabled() {
        String propValue = configProperties.getProperty(PROP_ML_DISTRIBUTION_ASDC_CONNECTION_DISABLED);
